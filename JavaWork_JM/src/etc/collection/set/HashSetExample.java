...
//		set은 인덱스가 없어서 method를 이용해서 객체를 얻는게 아니라
//		반복자(Iterartor)를 통해서 요소를 하나씩 꺼내 보셔야 한다
//		반복자 객체는 set인터페이스가 제공하는 iterator()를 호출하여 얻어옴
		
		Iterator<String> iter = set.iterator();
		
//		Iterator 객체의 메서드 next()를 통해
//		내부 요소를 하나씩 꺼내올 수 있다
//		next()를 요소의 개수보다 많이 호출하게되면
//		NoSuchElement 예외가 발생한다
		
//		hasNext() >> 반복자가 가지고 있는 객체를 더 가지고 올 수 있는지
