...
public class ListQuiz02 {
	...
	public static void main(String[] args) {
        ...
        */
		...
		User a = new User("홍길동",31);
		User b = new User("김길동",40);
		User c = new User("박길동",49);
		
		Collections.addAll(abc, a,b,c);
		...
		for(int i=0;i<abc.size();i++) {
			if(abc.get(i).getName().equals("홍길동")) {
				abc.remove(i);
...
//		향상 for문은 반복문을 시작할 때 구조적으로 컬렉션의 크기 및
//		사용 가능한 요소들의 개수를 항상 파악하고 있기 때문에
//		값의 변경이 일어나면 예외를 발생시기도록 설계되어있습니다
